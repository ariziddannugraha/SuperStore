...
# --- PAGE CONFIGURATION ---
st.set_page_config(
    page_title="Global Superstore - Investor & Revival Dashboard v4",
    page_icon="📈",
    layout="wide",
...
# --- TITLE HEADER ---
st.markdown('<p class="main-title">Global Superstore: Revival & Investor Forecast Dashboard (v4)</p>', unsafe_allow_html=True)
            ...
            for d in dates:
                if np.random.rand() > 0.3:
                    ...
                    for _ in range(num_orders):
                        m = np.random.choice(markets, p=[0.28, 0.24, 0.19, 0.12, 0.08, 0.06, 0.03])
...
st.divider()
st.caption("Global Superstore Analytics & Forecasting Dashboard v4 | Dynamic Live-Updating Scenario Simulator")
